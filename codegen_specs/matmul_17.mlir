module {
  ...
  ^bb0(%arg0: !transform.any_op):
    ...
    %forall_op, %tiled_op = transform.structured.tile_to_forall_op %first   num_threads [] tile_sizes [64](mapping = [#gpu.block<x>]) : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    ...
    %tiled_linalg_op, %loops = transform.structured.tile %first_0[0, 0, 1] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    ...
    %forall_op_6, %tiled_op_7 = transform.structured.tile_to_forall_op %8   num_threads [0, 8, 8] tile_sizes [](mapping = [#gpu.linear<y>, #gpu.linear<x>]) : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    ...
    %forall_op_8, %tiled_op_9 = transform.structured.tile_to_forall_op %padded   num_threads [2] tile_sizes [](mapping = [#gpu.warp<x>]) : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    ...
    %forall_op_10, %tiled_op_11 = transform.structured.tile_to_forall_op %fused_op_2   num_threads [2] tile_sizes [](mapping = [#gpu.warp<x>]) : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    ...
    %forall_op_12, %tiled_op_13 = transform.structured.tile_to_forall_op %rest_1   num_threads [32, 2] tile_sizes [](mapping = [#gpu.linear<y>, #gpu.linear<x>]) : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
    ...
    transform.iree.map_nested_forall_to_gpu_threads %20 workgroup_dims = [8, 8, 1] warp_dims = [2, 1, 1] subgroup_size = 32 : (!transform.any_op) -> ()
