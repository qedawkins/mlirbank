...
module {
    ...
    objects = #hal.executable.objects<{
      #spirv_target = [
        #hal.executable.object<{
          path = "/home/quinn/nod/uVkCompute/benchmarks/argmax/one_workgroup_argmax_subgroup_f32.spv"
          // path = "/home/quinn/nod/uVkCompute/benchmarks/argmax/one_workgroup_argmax_loop.spv"
        }>
      ]
    }>
  } {
  ...
  func.func @forward(%arg0: tensor<1x32000xf32>) -> tensor<1xi32> {
    %empty = tensor.empty() : tensor<1xi32>
    %c1 = arith.constant 1 : index
    %dim = tensor.dim %arg0, %c1 : tensor<1x32000xf32>
    %dim_i32 = arith.index_cast %dim : index to i32
    %4 = flow.dispatch @subgroup_argmax::@main[%dim](%dim_i32, %arg0, %empty) : (i32, tensor<1x32000xf32>, tensor<1xi32>) -> %empty
