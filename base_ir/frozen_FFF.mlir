...
!full_in_t = tensor<?x256xf32>
!in_t = tensor<256xf32>
!score_t = tensor<f32>
!full_out_t = tensor<?x128xf32>
!out_t = tensor<128xf32>
...
module {
  ...
  func.func @forward(%in: !full_in_t, %w1: !w1_t, %w2: !w2_t) -> !full_out_t {
    ...
    %0 = flow.dispatch @forward_dispatch_fff_0::@forward_dispatch_fff_0[%batch](%batch_i64, %in, %w1, %w2) : (i64, !full_in_t{%batch}, !w1_t, !w2_t) -> !full_out_t{%batch}
    return %0 : !full_out_t
  }
}
